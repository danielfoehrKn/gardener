...
func RegisterLandscaperCommonFrameworkFlags() *LandscaperCommonConfig {
	...
	flag.StringVar(&newCfg.ComponentConfig.baseUrl, "componentBaseUrl", "", "the base url of the component descriptor (e.g. eu.gcr.io/gardener-project/landscaper/dev/components)")
	flag.StringVar(&newCfg.ComponentConfig.name, "componentName", "", "the name of the component descriptor (e.g. github.com/gardener/gardener)")
	flag.StringVar(&newCfg.ComponentConfig.version, "componentVersion", "", "the version of the component descriptor (e.g. 1.19.0)")
		...
		Spec: landscaperv1alpha1.InstallationSpec{
			Blueprint: landscaperv1alpha1.BlueprintDefinition{
				Reference: &landscaperv1alpha1.RemoteBlueprintReference{
					...
					// with type:blueprint and name: blueprint
...
// CreateInstallation creates a new config map with retries
