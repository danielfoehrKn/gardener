...
type Imports struct {
	...
	// +optional
	DeploymentConfiguration *seedmanagementv1alpha1.GardenletDeployment `json:"deploymentConfiguration"`
	...
	// +optional
	ImageVectorOverwrite *json.RawMessage `json:"imageVectorOverwrite,omitempty" protobuf:"bytes,12,opt,name=imageVectorOverwrite"`
	// ComponentImageVectorOverwrites contains an optional image vector override for components deployed by the gardenlet.
	// +optional
	ComponentImageVectorOverwrites *json.RawMessage `json:"componentImageVectorOverwrites,omitempty" protobuf:"bytes,13,opt,name=componentImageVectorOverwrites"`
}
